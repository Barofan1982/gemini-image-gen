...
class App(tk.Tk):
    ...
    def _build_left(self, parent):
        ...
        ttk.Button(btn_ref, text="删除选中", command=self._remove_ref_image,
                   style="Danger.TButton").pack(side="right", padx=2)
        ttk.Button(btn_ref, text="清空",    command=self._clear_ref,
                   style="Danger.TButton").pack(side="right", padx=2)
        ...
        self._log_text = tk.Text(log_frame, state="disabled", wrap="word",
                                 background=self.C["log_bg"], foreground="#c9d1d9",
    ...
    def _build_right(self, parent):
        ...
        btn_row.pack(fill="x", padx=8, pady=(4, 8), side="bottom")
        ttk.Button(btn_row, text="💾 保存图片",
                   command=self._save_image).pack(side="right", padx=(4, 0))
        ttk.Button(btn_row, text="＋ 新对话",
                   command=self._new_chat).pack(side="right", padx=4)
        ...
        self._input_text = tk.Text(input_frame, wrap="word",
                                   font=("Segoe UI", 10),
                                   background="#ffffff", foreground=self.C["text"],
