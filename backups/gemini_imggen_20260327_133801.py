...
class App(tk.Tk):
    ...
    C = {
        ...
        "panel":       "#ffffff",   # 右侧面板
        "accent":      "#2563eb",   # 主色调（蓝）
        "accent_dk":   "#1d4ed8",   # hover 深蓝
        "accent_lt":   "#dbeafe",   # 浅蓝（用户气泡）
        "ai_bubble":   "#f1f5f9",   # AI 气泡
        "border":      "#e2e8f0",   # 边框
        "text":        "#0f172a",   # 主文字
        "text_sub":    "#64748b",   # 次要文字
        "danger":      "#dc2626",   # 删除按钮
        "log_bg":      "#0d1117",   # 日志背景
        "status_bg":   "#1e293b",   # 状态栏
        "status_fg":   "#94a3b8",   # 状态文字
        "ok":          "#22c55e",
        "warn":        "#f59e0b",
        "error":       "#ef4444",
    }
    ...
    def _setup_styles(self):
        ...
        s.configure("TLabelframe",
                    background=C["sidebar"], relief="flat",
                    bordercolor=C["border"], borderwidth=1)
        s.configure("TLabelframe.Label",
                    background=C["sidebar"], foreground=C["text_sub"],
        ...
        s.configure("Danger.TButton",
                    background="#fff0f0", foreground=C["danger"],
                    font=("Segoe UI", 9), relief="flat",
                    padding=(10, 5), borderwidth=1,
                    bordercolor="#fecaca")
        ...
        s.configure("TCombobox",
                    fieldbackground=C["sidebar"], background=C["sidebar"],
                    foreground=C["text"], arrowcolor=C["text_sub"],
                    bordercolor=C["border"], lightcolor=C["border"],
                    darkcolor=C["border"])
        s.map("TCombobox",
              fieldbackground=[("readonly", C["sidebar"])],
        ...
        s.configure("Treeview.Heading",
                    background=C["bg"], foreground=C["text_sub"],
        ...
        s.configure("TScrollbar",
                    ...
                    arrowcolor=C["text_sub"], relief="flat", width=8)
        s.map("TScrollbar",
              background=[("active", C["text_sub"])])
